package dev.akarah.purpur.editor.decompiler;

import com.google.common.collect.Lists;
import dev.akarah.purpur.editor.mappings.MappingsRepository;
import dev.akarah.purpur.editor.parser.ast.Block;
import dev.akarah.purpur.editor.parser.ast.stmt.Invoke;
import dev.akarah.purpur.editor.parser.ast.value.Variable;
...
public class CodeBlockDecompiler {
        ...
        switch (codeBlock) {
            ...
            case EntityEvent entityEvent -> {
                ...
                return new Invoke(
                        ...
                        Optional.empty(),
                        Optional.empty(),
                        entityEvent.isLagslayCancelled()
                );
            }
    ...
    private static List<dev.akarah.purpur.editor.parser.ast.value.Value> mapArguments(CodeBlockAction action) {
